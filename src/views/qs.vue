<template>
  ...
  >
    <el-table-column prop="name" label="券商">
      <template #default="scope">
        <div style="display: flex; line-height: 40px; width: 120px">
          <img
            :src="`./icon/${scope.row.name}.png`"
    ...
    <el-table-column label="认购费用">
      <el-table-column sortable width="120" prop="现金认购费" label="现金认购">
        <template #default="scope">
          {{ scope.row.现金认购费 === -1 ? "不支持" : scope.row.现金认购费 }}
        </template>
      </el-table-column>
      <el-table-column prop="融资认购费" label="融资认购"> </el-table-column>
    </el-table-column>

    <el-table-column label="认购细节">
      <el-table-column prop="融资倍数" label="融资倍数"> </el-table-column>
      <el-table-column prop="融资额度" label="融资额度">
        <template #default="scope">
    ...
    <el-table-column label="交易成本">
      <el-table-column prop="交易万元佣金" label="万元佣金" width="90">
      </el-table-column>
      <el-table-column prop="港股平台费" label="平台费"> </el-table-column>
      <el-table-column
        sortable
        width="110"
        prop="综合交易佣金"
      ...
      <el-table-column prop="出金手续费" label="出金费用"> </el-table-column>
      <el-table-column prop="出金结算时间" label="出金结算"> </el-table-column>
      <el-table-column prop="卖出资金可用" label="卖出可用"> </el-table-column>
    </el-table-column>
    <!-- <el-table-column
           prop="软件下载"
           label="软件下载">
